...
(function () {
    ...
    var initActionBtn = function () {
        ...
        function genConfigDom() {
            var _a;
            var btnText = (_a = document.getElementById('config-btn')) === null || _a === void 0 ? void 0 : _a.innerHTML;
            if (btnText && btnText === 'Show Config') {
                configWrapper.style.display = 'flex';
                document.getElementById('config-btn').innerHTML = 'Hide Config';
            }
            else {
                configWrapper.style.display = 'none';
                document.getElementById('config-btn').innerHTML = 'Show Config';
            }
        }
